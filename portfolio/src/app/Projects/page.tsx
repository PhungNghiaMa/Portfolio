    ...
    return (
        <div className="ProjectContainer w-full h-max px-22">
            <div className="Title w-fit h-auto flex items-center ">
                <h1 className="projects text-5xl italic font-bold py-20 ">projects</h1>
            </div>
                    ...
                    <table className="ProjectTable w-full border-collapse border border-gray-800 relative">
                        ...
                        <tbody className="w-full h-max">
                            <tr className="BodyRow italic font-semibold text-center">
                                <td className=" border border-gray-800 p-2">Predictive education advisory system</td>
                                ...
                                <td className="border border-gray-800 p-2">School project</td>
                                <td className="border border-gray-800 p-2">Frontend developer</td>
                                <td className="border border-gray-800 p-2">Python, Flask, React.js, Foundation Sites</td>
                                <td className="border border-gray-800 p-2 Finished">Finished</td>
                                <td className="border border-gray-800 p-2">
                            ...
                            <tr className=" BodyRow text-center italic font-semibold ">
                                <td className="border border-gray-800 p-2">Simple Pokémon game</td>
                                <td className="border border-gray-800 p-2">
                                    Develope Pokémon database using crawling techniques and PokeCat game using Golang
                                </td>
                                <td className="border border-gray-800 p-2">School project</td>
                                <td className="border border-gray-800 p-2">Backend developer</td>
                                <td className="border border-gray-800 p-2">Golang ( mutex , channel , go routine ) , Playwright , Termbox</td>
                                <td className="border border-gray-800 p-2 Finished">Finished</td>
                                <td className="border border-gray-800 p-2">
                            ...
                            <tr className="BodyRow text-center italic font-semibold ">
                                <td className="border border-gray-800 p-2">Content Management System</td>
                                <td className="border border-gray-800 p-2">
                                    Develop an web application to write content as form of Markdown
                                </td>
                                <td className="border border-gray-800 p-2">School project</td>
                                <td className="border border-gray-800 p-2">Backend developer</td>
                                <td className="border border-gray-800 p-2">Golang , Gin , GORM</td>
                                <td className="border border-gray-800 p-2 Finished">Finished</td>
                                <td className="border border-gray-800 p-2">
                            ...
                            <tr className="BodyRow text-center italic font-semibold ">
                                <td className="border border-gray-800 p-2">Java Chess Game</td>
                                <td className="border border-gray-800 p-2">
                                    Develop a simple chess by applying design pattern and OOP principles using Java
                                </td>
                                <td className="border border-gray-800 p-2">School project</td>
                                <td className="border border-gray-800 p-2">Backend developer</td>
                                <td className="border border-gray-800 p-2">Java , Design pattern ( Decorator ) , Java Swing</td>
                                <td className="border border-gray-800 p-2 Finished">Finished</td>
                                <td className="border border-gray-800 p-2">
                            ...
                            <tr className="BodyRow text-center italic font-semibold ">
                                <td className="border border-gray-800 p-2">Password Manager</td>
                                <td className="border border-gray-800 p-2">
                                    Develop a web application to manage and check password using Golang and Next.js
                                </td>
                                <td className="border border-gray-800 p-2">Personal project</td>
                                <td className="border border-gray-800 p-2">Fullstack developer</td>
                                <td className="border border-gray-800 p-2">Golang , Next.js , PostgreSQL , Tailwind CSS</td>
                                <td className="border border-gray-800 p-2 InProgress">In progress</td>
                                <td className="border border-gray-800 p-2"></td>
                            </tr>

                            <tr className="BodyRow text-center italic font-semibold ">
                                <td className="border border-gray-800 p-2">Hat Boi 3D Virtual Museum</td>
                                <td className="border border-gray-800 p-2">
                                    Develop a virtual museum on web platform that users can visit and explore the museum using 3D model
                                </td>
                                <td className="border border-gray-800 p-2">Thesis</td>
                                <td className="border border-gray-800 p-2">Fullstack developer</td>
                                <td className="border border-gray-800 p-2">Golang ( intend ) , Next.js ( intend ) , Three.js , Blender , PostgreSQL ( intend )</td>
                                <td className="border border-gray-800 p-2 InProgress">In progress</td>
                                <td className="border border-gray-800 p-2"></td>
                            </tr>
                        </tbody>
